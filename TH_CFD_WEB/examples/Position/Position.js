...
var PositionTest = React.createClass({
        ...
        render : function(){
            var tabPages = [
            <PositionLoadmore dataURL={urls[0]} key={0} ref={'page0'} isOwnStockPage={true} loadCallBack={this.slideCallback}  loadoverTitle={"没有更多信息了. . ."}  />, 
            <StockClosedPositionPage dataURL={urls[1]} key={1} ref={'page1'} />,
            <PositionStatistical  />
            ]
            var elements=[];
