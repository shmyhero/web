...
/***/ function(module, exports, __webpack_require__) {
	...
	var SliderList = __webpack_require__(181);
	var Tip = __webpack_require__(173);
	//var Form = require("Form");
	var ScrollLoadmore = __webpack_require__(183);
	var SearchBox = __webpack_require__(184);
	var Sortable = __webpack_require__(185);
	...
	var urls = [GET_USER_BOOKMARK_LIST_API, GET_US_STOCK_TOP_GAIN_API, GET_INDEX_LIST_API, GET_FX_LIST_API, GET_FUTURE_LIST_API];
	...
	var SliderTest = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        $.connection.Q.client.p = function (stockInfo) {
	            _this.refs['page' + _this.state.currentSelectedTab].handleStockInfo(stockInfo);
	        };
	    },
	    init: function init() {
	    ...
	    initindex: function initindex(index) {
	        if (index === 0) {
	    ...
	    render: function render() {
	        ...
	        var tabs = tabNames.map(function (tabName, i) {
	            return elements.push(React.createElement(ScrollLoadmore, { dataURL: urls[i], key: i, ref: 'page' + i, isOwnStockPage: i == 0, header: i == 1, hasMore: i == 1, loadCallBack: _this2.slideCallback, loadoverTitle: "没有更多信息了. . ." }));
	        });
	        return React.createElement(SliderList, { sliders: elements, ref: 'Slider1', sliderIndex: this.state.currentSelectedTab, sliderNext: this.state.sliderNext, ischange: this.state.ischange, isNext: this.state.isNext, isNext: this.state.isNext, callback: this.slideCallback, isHorizontal: this.props.isHorizontal, slideType: "drawer" });
	    }
	...
	var TestTip = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            tip: React.createElement(Tip, { message: "Tip提示3秒后消失", timeout: 30000, callback: this.tipClose })
	        };
	    },
	...
	React.render(React.createElement(SliderTest, { isPager: false, isHorizontal: true }), document.getElementById("tab-content"));

	React.render(React.createElement(SearchBoxTest, { suggestUrl: GET_SEARCH_STOCK_API, btnName: "取消" }), document.getElementById("Suggest"));

	React.render(React.createElement(Sortable, { dataURL: GET_USER_BOOKMARK_LIST_API }), document.getElementById("bookmark"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SliderItem = __webpack_require__(182);
	//var Tip = require("Tip");
	var SliderList = React.createClass({
	    ...
	    componentDidUpdate: function componentDidUpdate() {
	        if (this.props.isTouchend) {
	            if (!this.props.isSuccess) {} else {
	                ...
	                console.log('componentDidUpdate' + this.props.sliderIndex);
	    ...
	    getShowprops: function getShowprops(sliderIndex, isNext) {
	        console.log('getShowprops' + sliderIndex);
	        //this.props.isNext=isNext;
	    ...
	    render: function render() {
	        ...
	        var SliderItems = this.props.sliders.map(function (sliderValue, index) {
	            ...
	            return React.createElement(SliderItem, { element: sliderValue,
	                zIndex: zIndex,
	                isShow: isShow,
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SliderList.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SliderItem.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollLoadmore = React.createClass({
	    ...
	    sortRawData: function sortRawData(newType, data) {
	    ...
	    renderSortText: function renderSortText() {
	    ...
	    replacetotickview: function replacetotickview(securityId) {
	    ...
	    render: function render() {
	        ...
	        var newElements = this.state.stockInfo.map(function (rowData, index) {
	            return React.createElement(
	                "li",
	                { className: "item Grid", onClick: o.replacetotickview.bind(this, rowData.id) },
	                React.createElement(
	                    "div",
	                ...
	                React.createElement(
	                    "div",
	                    { className: "Price Grid-cell u-1of41" },
	                    " ",
	                    rowData.last.toFixed(4)
	                ),
	                React.createElement(
	                    "div",
	                    { className: "Percent Grid-cell u-1of51 " + (rowData.last === rowData.open ? "stopPercent" : rowData.last - rowData.open > 0 ? "risePercent" : "fallPercent") },
	        ...
	        if (this.props.header) {
	            liheader = React.createElement(
	                "li",
	                { className: "label  Grid", onClick: this.handlePress },
	                React.createElement(
	                    "div",
	                    { className: " Grid-cell u-1" },
	                    " 涨跌榜 "
	                ),
	                React.createElement(
	                    "div",
	                    { className: " Grid-cell u-2" },
	                    this.renderSortText(),
	                    " "
	                )
	            );
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ScrollLoadmore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBox = React.createClass({
	    ...
	    addlocalStorage: function addlocalStorage(id, name, symbol) {
	    ...
	    //获取历史搜索
	    getHistorySuggest: function getHistorySuggest() {
	        var o = this;
	        var HistoryStock = this.getParam("HistoryStock");
	        if (HistoryStock != null) {
	            ...
	            var rightPartContent = React.createElement(
	                "div",
	                { className: " Grid-cell u-1of5" },
	                "已添加"
	            );
	            ...
	            this.props.getHistorySuggestElement = HistorysuggestData.map(function (key, index) {
	                ...
	                if (index == 0) {
	                    ...
	                    if (arrStocks.indexOf(key.id) == -1) {
	                        rightPartContent = React.createElement(
	                            "div",
	                            { className: "Grid-cell u-1of5" },
	                            " ",
	                            React.createElement(
	                                "i",
	                                { className: "yo-ico", onClick: o.addToMyListPressed.bind(this, key.id, index) },
	                                " "
	                            ),
	                            " "
	                        );
	                    ...
	                    return React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "last Grid-cell u-1of1", onClick: o.replacetotickview.bind(this, key.id) },
	                            React.createElement(
	                                "p",
	                                { className: "name" },
	                                key.name,
	                ...
	                if (suggestData.length > 0 && this.props.inputValue != "") {
	                    ...
	                    this.props.suggestElement = suggestData.map(function (key, index) {
	                        ...
	                        return React.createElement(
	                            ...
	                            React.createElement(
	                                "div",
	                                { className: "last Grid-cell u-1of1", onClick: o.addlocalStorage.bind(this, key.id, key.name, key.symbol) },
	                                React.createElement(
	                                    "p",
	                                    { className: "name" },
	                                    key.name,
	                    ...
	                    if (this.props.inputValue != "") {
	                        this.props.suggestElement = React.createElement(
	                            "li",
	                            { className: "label Grid" },
	                            React.createElement(
	                                "div",
	    ...
	    addToMyListPressed: function addToMyListPressed(id, rowID) {
	        var userData = LogicData.getUserData();
	        $.ajax({
	    ...
	    addToMyHistoryListPressed: function addToMyHistoryListPressed(id, rowID) {
	    ...
	    render: function render() {
	        ...
	        if (this.props.isSuggest && this.props.suggestElement != null) {
	            suggestElement = React.createElement(
	                "div",
	                { className: "flex cont" },
	                React.createElement(
	                    "div",
	                    { className: "yo-group yo-list" },
	                    React.createElement(
	                        "ul",
	                        { className: "yo-list" },
	            ...
	            suggestElement = React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "ul",
	                        { className: "yo-tabclear" },
	                        React.createElement(
	                            "li",
	                            { className: "item " },
	                            React.createElement("input", { type: "button", value: "清除历史记录", onClick: this.clearHistory, className: "yo-btn yo-btn-e" })
	                        )
	                    )
	                )
	            );
	        ...
	        return React.createElement(
	            "div",
	            { className: "yo-suggest yo-suggest-modal yo-suggest-on" },
	            React.createElement(
	                "div",
	                { className: "operate yo-header" },
	                React.createElement(
	                    "div",
	                    { className: "action" },
	                    React.createElement("input", { type: "search", placeholder: "搜索金融产品", className: "input", onChange: this.inputChange, onBlur: this.onBlur, ref: "key" }),
	                    React.createElement(
	                        "label",
	                        { className: "label", htmlFor: "yo-search-input" },
	                        React.createElement(
	                            "i",
	                            { className: "yo-ico yo-ico-search" },
	                            ""
	                        )
	                    ),
	                    React.createElement(
	                        "i",
	                        { className: "yo-ico " + (this.props.inputValue != "" ? "yo-ico-delete" : "yo-ico-loading"), onClick: this.clearInput },
	                        ""
	                    )
	                ),
	                React.createElement(
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SearchBox.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sortable = React.createClass({
	    ...
	    propTypes: {
	        loadingTitle: React.PropTypes.string, //加载标题
	        dataURL: React.PropTypes.string, //数据url 
	        postdataURL: React.PropTypes.string },
	    //数据url             
	    getDefaultProps: function getDefaultProps() {
	        return {
	            elements: [],
	    ...
	    render: function render() {
	        var newElements = this.state.stockInfo.map(function (rowData, index) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("input", { type: "checkbox", value: rowData.id, id: "checkboxFiveInput" + index }),
	                    React.createElement("label", { htmlFor: "checkboxFiveInput" + index })
	                ),
	                React.createElement(
	                    "div",
	                    { className: "last col c1  Grid-cell u-1of2" },
	                    React.createElement(
	                        "p",
	                        { className: "name" },
	                        rowData.name
	        ...
	        return React.createElement(
	            "div",
	            { className: "yo-flex scroll-in" },
	            React.createElement(
	                "header",
	                { className: "yo-header m-header" },
	                React.createElement(
	                    "h2",
	                    { className: "title" },
	                    "我的自选"
	                ...
	                React.createElement(
	                    "span",
	                    { className: "regret wancheng", onClick: this.getList },
	                    "完成"
	                )
	            ),
	            React.createElement(
	            ...
	            React.createElement(
	                "section",
	                { className: "m-footlayer" },
	                React.createElement(
	                    "ul",
	                    { className: "yo-tabfoot" },
	                    React.createElement(
	                        "li",
	                        { className: "item " },
	                        React.createElement("input", { type: "button", onClick: this.selectAll, value: "全部", className: "yo-btn yo-btn-s", id: "selectAll" }),
	                        " "
	                    ),
	                    React.createElement(
	                        "li",
	                        { className: "item " },
	                        React.createElement("input", { type: "button", onClick: this.getValue, value: "删除", className: "yo-btn yo-btn-e ", id: "getValue" })
	                    )
	                )
	            )
	        );
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Sortable.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
