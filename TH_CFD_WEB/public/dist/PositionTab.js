...
/******/ 	var hotCurrentHash = "170b82a634c32f69bcf8"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionList = __webpack_require__(171);
	var Tip = __webpack_require__(173);
	//var Form = require("Form");
	var PositionLoadmore = __webpack_require__(174);
	var StockClosedPositionPage = __webpack_require__(179);
	var PositionStatistical = __webpack_require__(180);

	var NetConstants = __webpack_require__(176);

	var tabNames = ['持仓', '平仓', '统计'];

	var urls = [NetConstants.POST_CREATE_POSITION_API, NetConstants.POST_CREATE_POSITION_API, NetConstants.POST_CREATE_POSITION_API];
	...
	var PositionTest = React.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        $(".yo-Htab li").click(function () {
	            ...
	            if (index !== o.state.currentSelectedTab) {
	                ...
	                o.refs['Slider1'].getShowprops(index);
	            }
	        });
	    },
	    ...
	    render: function render() {
	        var tabPages = [React.createElement(PositionLoadmore, { dataURL: urls[0], key: 0, ref: 'page0', isOwnStockPage: true, loadCallBack: this.slideCallback, loadoverTitle: "没有更多信息了. . ." }), React.createElement(StockClosedPositionPage, { dataURL: urls[1], key: 1, ref: 'page1' }), React.createElement(PositionStatistical, null)];
	        var elements = [];
	        var tabs = tabNames.map(function (tabName, i) {
	            return elements.push(tabPages[i]);
	        });
	        return React.createElement(PositionList, { sliders: elements, ref: 'Slider1', sliderIndex: this.state.currentSelectedTab, sliderNext: this.state.sliderNext, ischange: this.state.ischange, isNext: this.state.isNext, isNext: this.state.isNext, callback: this.slideCallback, isHorizontal: this.props.isHorizontal, slideType: "drawer" });
	    }
	...
	var SearchBoxTest = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(SearchBox, { suggestUrl: this.props.suggestUrl, btnName: this.props.btnName, callback: this.slideCallback });
	    }
	});
	...
	var TestTip = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            tip: React.createElement(Tip, { message: "Tip提示3秒后消失", timeout: 3000, callback: this.tipClose })
	        };
	    },
	    tipClose: function tipClose() {
	        this.setState({
	            tip: null
	        });
	    },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Position.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionItem = __webpack_require__(172);
	//var Tip = require("Tip");
	var PositionList = React.createClass({
	    ...
	    getShowprops: function getShowprops(sliderIndex) {
	    ...
	    render: function render() {
	        ...
	        var SliderItems = this.props.sliders.map(function (sliderValue, index) {
	            ...
	            return React.createElement(PositionItem, { element: sliderValue,
	                zIndex: zIndex,
	                isShow: isShow,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionLoadmore = React.createClass({
	    ...
	    getShownStocks: function getShownStocks() {
	        var result = '';
	    ...
	    handleStockInfo: function handleStockInfo(realtimeStockInfo) {

	        var hasUpdate = false;
	        for (var i = 0; i < this.state.rowStockInfoData.length; i++) {
	            for (var j = 0; j < realtimeStockInfo.length; j++) {
	                if (this.state.rowStockInfoData[i].id == realtimeStockInfo[j].id && this.state.rowStockInfoData[i].last !== realtimeStockInfo[j].last) {
	    ...
	    stockPressed: function stockPressed(rowData, rowID) {
	        this.setState({
	            showExchangeDoubleCheck: false
	        });
	        var newData = [];
	    ...
	    subItemPress: function subItemPress(item, rowData) {
	    ...
	    okPress: function okPress(rowData) {
	    ...
	    loadOpenPositionInfo: function loadOpenPositionInfo() {
	        var userData = LogicData.getUserData();
	        $.ajax({
	    ...
	    loadStockDetailInfo: function loadStockDetailInfo(stockCode) {
	        var userData = LogicData.getUserData();
	    ...
	    renderDetailInfo: function renderDetailInfo(rowData) {
	        var _this = this;
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "li",
	                { className: "item1 Grid" },
	                React.createElement(
	                    "div",
	                    { className: "last1 Grid-cell u-1of3" },
	                    React.createElement(
	                        "div",
	                        { className: "name" },
	                        "类型"
	                    ),
	                    React.createElement("img", { className: "symbol", src: tradeImage })
	                ),
	                React.createElement(
	                    "div",
	                    { className: "last1 Grid-cell u-1of3" },
	                    React.createElement(
	                        "div",
	                        { className: "name aligncenter" },
	                        "本金"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "symbol aligncenter" },
	                        rowData.invest.toFixed(2)
	                    )
	                ),
	                React.createElement(
	                    "div",
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "name alignright" },
	                        "杠杆"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "symbol alignright" },
	                        rowData.leverage
	                    )
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "symbol extendTextBottom" },
	                        rowData.settlePrice
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "name extendTextTop aligncenter" },
	                        "当前价格"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "symbol extendTextBottom aligncenter" },
	                        rowData.security.last
	                    )
	                ),
	                React.createElement(
	                    "div",
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "name extendTextTop alignright" },
	                        "价差"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "symbol extendTextBottom alignright" },
	                        (rowData.security.last - rowData.settlePrice).toFixed(2)
	                    )
	                )
	            ),
	            React.createElement(
	                "li",
	                { className: "item2 centerText " },
	                React.createElement(
	                    "div",
	                    { className: " centerText " },
	                    showNetIncome ? React.createElement(
	                        "div",
	                        { className: " netIncomeText" },
	                        "净收益:9.26"
	                    ) : null,
	                    React.createElement(
	                        "div",
	                        ...
	                        React.createElement("input", { type: "button", onClick: function () {
	                                return _this.okPress(rowData);
	                            }, value: upl, className: "yo-btn " + (this.state.showExchangeDoubleCheck ? "yo-btn-upl1" : "yo-btn-upl") })
	                    ),
	                    this.state.showExchangeDoubleCheck ? React.createElement(
	                        "div",
	                        { className: " feeText" },
	                        "平仓费：0"
	                    ) : null
	    ...
	    render: function render() {
	        ...
	        var newElements = this.state.stockInfo.map(function (rowData, index) {
	            ...
	            if (this.state.selectedRow === index) {
	                liheader = React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "li",
	                            { className: "item1 Grid", onClick: o.stockPressed.bind(this, rowData, index) },
	                            React.createElement(
	                                "div",
	                                { className: "last Grid-cell u-1" },
	                                React.createElement(
	                                    "div",
	                                    { className: "name" },
	                                    " ",
	                            ...
	                            React.createElement(
	                                "div",
	                                { className: "Percent Grid-cell u-1of51 " + (rowData.security.last === rowData.settlePrice ? "stopPercent" : rowData.security.last - rowData.settlePrice > 0 ? "risePercent" : "fallPercent") },
	                ...
	                liheader = React.createElement(
	                    "li",
	                    { className: "item Grid", onClick: o.stockPressed.bind(this, rowData, index) },
	                    React.createElement(
	                        "div",
	                        { className: "last Grid-cell u-1" },
	                        React.createElement(
	            ...
	            return { liheader: liheader };
	        }, this);
	        var elements = [];
	        elements.push(newElements);
	        return React.createElement(
	            "section",
	            { className: "m-list scroll-in", ref: "listview" },
	            React.createElement(
	                "ul",
	                { className: "yo-list" },
	                elements
	            ),
	            React.createElement(TipConfirm, { ref: "confirmPage", callback: this.showCallback })
	        );
	    }
	});
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PositionLoadmore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogicData = {
	    ...
	    setMYSecurityData: function setMYSecurityData(SecurityData) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GET_PHONE_CODE_API = SERVER_IP + '/api/sendCode';
	exports.GET_PHONE_CODE_API = GET_PHONE_CODE_API;
	var PHONE_NUM_LOGIN_API = SERVER_IP + '/api/user/signupByPhone';
	exports.PHONE_NUM_LOGIN_API = PHONE_NUM_LOGIN_API;
	var WECHAT_LOGIN_API = SERVER_IP + '/api/user/signupByWeChat';
	exports.WECHAT_LOGIN_API = WECHAT_LOGIN_API;
	var GET_USER_INFO_API = SERVER_IP + '/api/user/me';
	exports.GET_USER_INFO_API = GET_USER_INFO_API;
	var SET_USER_NICKNAME_API = SERVER_IP + '/api/user/nickname';
	exports.SET_USER_NICKNAME_API = SET_USER_NICKNAME_API;
	var GET_USER_BOOKMARK_LIST_API = SERVER_IP + '/api/security/bookmark';
	exports.GET_USER_BOOKMARK_LIST_API = GET_USER_BOOKMARK_LIST_API;
	var GET_US_STOCK_TOP_GAIN_API = SERVER_IP + '/api/security/stock/topGainer';
	exports.GET_US_STOCK_TOP_GAIN_API = GET_US_STOCK_TOP_GAIN_API;
	var GET_US_STOCK_TOP_LOSER_API = SERVER_IP + '/api/security/stock/topLoser';
	exports.GET_US_STOCK_TOP_LOSER_API = GET_US_STOCK_TOP_LOSER_API;
	var GET_INDEX_LIST_API = SERVER_IP + '/api/security/index';
	exports.GET_INDEX_LIST_API = GET_INDEX_LIST_API;
	var GET_FX_LIST_API = SERVER_IP + '/api/security/fx';
	exports.GET_FX_LIST_API = GET_FX_LIST_API;
	var GET_FUTURE_LIST_API = SERVER_IP + '/api/security/futures';
	exports.GET_FUTURE_LIST_API = GET_FUTURE_LIST_API;
	var GET_SEARCH_STOCK_API = SERVER_IP + '/api/security/search';
	exports.GET_SEARCH_STOCK_API = GET_SEARCH_STOCK_API;
	var GET_STOCK_DETAIL_API = SERVER_IP + '/api/security/<stockCode>';
	exports.GET_STOCK_DETAIL_API = GET_STOCK_DETAIL_API;
	var GET_STOCK_PRICE_TODAY_API = SERVER_IP + '/api/quote/<stockCode>/tick/today';
	exports.GET_STOCK_PRICE_TODAY_API = GET_STOCK_PRICE_TODAY_API;
	var OWN_STOCK_LIST_API = SERVER_IP + '/api/security/bookmark';
	exports.OWN_STOCK_LIST_API = OWN_STOCK_LIST_API;
	var GET_OPEN_POSITION_API = SERVER_IP + '/api/position/open';
	exports.GET_OPEN_POSITION_API = GET_OPEN_POSITION_API;
	var POST_CREATE_POSITION_API = SERVER_IP + '/api/position';
	exports.POST_CREATE_POSITION_API = POST_CREATE_POSITION_API;
	var POST_DELETE_POSITION_API = SERVER_IP + '/api/position/net';
	exports.POST_DELETE_POSITION_API = POST_DELETE_POSITION_API;
	var GET_USER_BALANCE_API = SERVER_IP + '/api/user/balance';

	exports.GET_USER_BALANCE_API = GET_USER_BALANCE_API;
	var PARAMETER_PHONE = 'phone';
	exports.PARAMETER_PHONE = PARAMETER_PHONE;
	var PARAMETER_VERFICATION_CODE = 'verifyCode';
	exports.PARAMETER_VERFICATION_CODE = PARAMETER_VERFICATION_CODE;
	var PARAMETER_NICKNAME = 'nickname';
	exports.PARAMETER_NICKNAME = PARAMETER_NICKNAME;
	var PARAMETER_STOCKIDS = 'securityIds';
	exports.PARAMETER_STOCKIDS = PARAMETER_STOCKIDS;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TipConfirm = React.createClass({
	    ...
	    show: function show(transactionInfo, callback) {
	        $(".pop2").show();
	        if (transactionInfo !== null) {
	            this.setState({
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "li",
	                        { className: "item3 Grid" },
	                        React.createElement(
	                            "div",
	                            { className: "last1 Grid-cell u-1" },
	                            React.createElement(
	                                "div",
	                                { className: "name" },
	                                this.state.name,
	                                " - ",
	                                this.state.isCreate ? '开仓' : '平仓',
	                                " "
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        "li",
	                        { className: "itemall flexGrid" },
	                        React.createElement(
	                            "div",
	                            { className: "last1 flexGrid-cell u-1of3" },
	                            React.createElement(
	                                "div",
	                                { className: "name" },
	                                "类型"
	                            ...
	                            React.createElement(
	                                "div",
	                                { className: "symbol" },
	                                React.createElement("img", { src: tradeImage })
	                            )
	                        ),
	                        React.createElement(
	                            "div",
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TipConfirm.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var height = $(".slider-inner").height();
	var extendHeight = 0;
	var tempData = [{ id: 13001, symbol: 'AAPL UW', name: '新东方', tag: 'US', profitPercentage: 0.1 }, { id: 13001, symbol: 'AAPL UW2', name: '新东方2', tag: 'US', profitPercentage: 0.05 }, { id: 13001, symbol: 'AAPL UW3', name: '新东方3', profitPercentage: -0.08 }, { id: 13001, symbol: 'AAPL UW4', name: '新东方4', profitPercentage: 0 }, { id: 13001, symbol: 'AAPL UW5', name: '新东方5', tag: 'US', profitPercentage: 0.1 }, { id: 13001, symbol: 'AAPL UW6', name: '新东方6', tag: 'US', profitPercentage: 0.05 }, { id: 13001, symbol: 'AAPL UW7', name: '新东方7', profitPercentage: -0.08 }, { id: 13001, symbol: 'AAPL UW8', name: '新东方8', profitPercentage: 0 }, { id: 13001, symbol: 'AAPL UW9', name: '新东方9', tag: 'US', profitPercentage: 0.1 }, { id: 13001, symbol: 'AAPL UW10', name: '新东方10', tag: 'US', profitPercentage: 0.05 }, { id: 13001, symbol: 'AAPL UW11', name: '新东方11', profitPercentage: -0.08 }, { id: 13001, symbol: 'AAPL UW12', name: '新东方12', profitPercentage: 0 }];
	var StockClosedPositionPage = React.createClass({
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "symbol extendTextBottom aligncenter netIncomeText" },
	                        "14.28"
	                    )
	                )
	            )
	    ...
	    render: function render() {
	                ...
	                liheader = React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "div",
	                                { className: "last Grid-cell u-1of21" },
	                                React.createElement(
	                                    "div",
	                                    { className: "name" },
	                                    " ",
	                            ...
	                            React.createElement(
	                                "div",
	                                { className: "Price Grid-cell u-1of51 " },
	                                "111"
	                            ),
	                            React.createElement(
	                                "div",
	                                { className: "Percent Grid-cell u-1of51 " + (rowData.profitPercentage === 0 ? "stopPercent" : rowData.profitPercentage > 0 ? "risePercent" : "fallPercent") },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(Tip, { ref: "confirmPage1" })
	        );
	    }
	});
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "StockClosedPositionPage.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionStatistical = React.createClass({
	    displayName: "PositionStatistical",
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "ul",
	                    { className: "yo-list centerText" },
	                    React.createElement(
	                        "li",
	                        { className: "item4" },
	                        React.createElement(
	                            "div",
	                            { className: "fontSize17a" },
	                            "总资产"
	                        )
	                    ),
	                    React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "li",
	                        { className: "itemf flexGrid" },
	                        React.createElement(
	                            "div",
	                            { className: "last1 flexGrid-cell u-1of2" },
	                            React.createElement(
	                                "div",
	                                { className: "name alignleft" },
	                                "累计收益"
	                            ),
	                            React.createElement(
	                                "div",
	                                { className: "symbol alignleft" },
	                                " 20099.69"
	                            )
	                        ),
	                        React.createElement(
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PositionStatistical.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
