...
;(function(exports){
	var KeyBoard = function(input, options){
		...
		//Button
		var btnStr1 = '<ul class="yo-list" > <li class="item Grid" > <div class="Grid-cell u-1of4 " >1</div>';


		var btnStr2 = '<div class="Grid-cell u-1of2 " >最低金额</div>';


		var btnStr = '<div class="Grid-cell u-1of4 " >完成</div><li> </ul>';
		...
		var tableStr = '<table id="' + TABLE_ID + '" border="0" cellspacing="0" cellpadding="0">';
			...
			tableStr += '</table>';
		this.el.innerHTML = cssStr +btnStr1+btnStr2+ btnStr + tableStr;
