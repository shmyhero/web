...
var PositionLoadmore = React.createClass({
    ...
    if (this.state.showSlider2) {
      ...
      $.ajax({
        ...
        data: {
          ...
          'price': this.percentToPriceWithRow(this.state.value1, rowData, 2)
        },
        dataType: 'json',
        //async : false,
        success: function(data) {
  ...
  renderDetailInfo: function(rowData) {
    ...
    var CURRENCY_CODE_LIST = {"CAD":"加元", "CHF":"瑞士法郎", "EUR":"欧元", "GBP":"英镑", "HKD":"港元", "JPY":"日元", "SEK":"瑞典克朗", "USD":"美元"}
    var currency = CURRENCY_CODE_LIST[rowData.security.ccy]
    ...
    var showNetIncome = false,extendHeight = 222;
    ...
    return (
      <ul className="yo-list">
            <li className="item1 Grid">
                ...
                <div className="last1 Grid-cell u-1of3" >
                    <div className="name aligncenter">本金({currency})</div>
