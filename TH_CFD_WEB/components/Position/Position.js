...
var PositionTest = React.createClass({
        ...
        componentDidMount  : function() {
          if(this.state.currentSelectedTab===0)
          {
            $.connection.Q.client.p =  (stockInfo)=> {
                 ...
                 this.refs['page0'].handleStockInfo(stockInfo)
            }
          }
        },
        init: function() {
            if(this.state.currentSelectedTab===0)
            {
              console.log(this.refs['page0'].getShownStocks());
             $.connection.Q.server.S(this.refs['page0'].getShownStocks());
            }
        },
        ...
        render : function(){
            ...
            return (
                <PositionList sliders= {elements} ref={'Slider1'}  sliderIndex={this.state.currentSelectedTab} sliderNext={this.state.sliderNext} ischange={this.state.ischange} isNext={this.state.isNext}  callback={this.slideCallback} isHorizontal={this.props.isHorizontal} slideType="drawer" />
            )
        }
