          ...
          //down
           ...
           $("#numberico").click(function(){
            ...
            $.connection.Q.client.p =  (stockInfo)=> {
                  ...
                  var classname='';
                  if(result.last !== yesterdayClose)
                  {
                   classname=(result.last - yesterdayClose) > 0 ? "risePercent" :"fallPercent";
                 }else{
                   classname='stopPercent';
                 }
                 $(".p2").addClass(classname);
                 $(".p2").addClass().html('<span>'+result.last +'</span> <span>'+ ((result.last - yesterdayClose) / yesterdayClose * 100).toFixed(2)+ '%</span>');
