  ...
  Model.prototype.query = function(query, callback) {
	...
	if(query.length > 3){
				  ...
				  $.ajax({
				  	...
				  	type : 'post',
				  	async : false,
				  	data : { action : 'SecuritiesSearch',txtSearch: query },
				  	//cache : false,
				  	dataType: 'JSON',
				    success: function(e) 
				      {
...
//[$${exchange}:${symbol}](tradehero://security/${id}_${exchange}_${symbol})
$.fn.atwho["default"] = {
  at: void 0,
  alias: void 0,
  data: null,
  displayTpl: "<li>${name}</li>",
  insertTpl: "[$${exchange}:${symbol}](tradehero://security/${id}_${exchange}_${symbol})",
