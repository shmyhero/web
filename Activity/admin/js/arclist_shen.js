...
function delArc(aid){
	...
	location="news_del_shen.php?qstr="+qstr+"&aid="+aid+"&dopost=delArchives";
}

function ShenArc(aid){
	var qstr=getCheckboxItem();
	if(aid==0) aid = getOneItem();
	location="news_del_shen.php?qstr="+qstr+"&aid="+aid+"&dopost=shenlArchives";
}

function NoShenArc(aid){
	var qstr=getCheckboxItem();
	if(aid==0) aid = getOneItem();
	location="news_del_shen.php?qstr="+qstr+"&aid="+aid+"&dopost=noshenArchives";
}
