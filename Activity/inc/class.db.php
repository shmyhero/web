...
<p>If you don't know how to setup a database you should <strong>contact your host</strong>.</p>");
	...
	function query($query) {
		...
		if ( preg_match("/^\\s*(insert|delete|update|replace) /i", strtolower($query)) ) {
			...
			if ( preg_match("/^\\s*(update) /i",$query) ){
				if ($EZSQL_ERROR['error_str'] == '') return 1;
			}
...
HEAD;
	 ...
	 * ͨ������Ҫʹ�� mysql_close()����Ϊ�Ѵ򿪵ķǳ־����ӻ��ڽű�ִ����Ϻ��Զ��رա�
	 */
	function disconnect() {
