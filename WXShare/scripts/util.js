!function() {
    ...
    "use strict";
    var n = {"TH-Api-Key": "TradeheroTempKey01","TH-Language-Code": "zh-CN","Authorization":"TH-WeChatU otwHxjsO4V9yAdAHXmYx9V7Y_L5s"};

     t.extend(t.ajaxSettings, {headers: n,dataType: "json",beforeSend: function() {
...
//        t.ajax({type: "GET",url: "https://cn1.api.tradehero.mobi/api/recommend",success: function() {
//                //console.log(e.eventType + " success"), n && "function" == typeof n && n() data: e,
//        	console.log(e)
//            }})
    }, t.download = function() {
